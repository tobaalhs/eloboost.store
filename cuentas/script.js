const accounts = [
    
    {
        ...
        images: [
            ...
            '/img/accounts/account1-4.png',
            '/img/accounts/account1-5.png',
            '/img/accounts/account1-6.png'
        ],
        rank: 'Unranked - Handlevel [2016]',
        level: 34,
        champions: 20,
        skins: 3,
        blueEssence: '10,100',
        price: '8,000 CLP',
        region: 'LAS',
        additionalInfo: 'Email cambiable'
    },
    {
        id: "ACC002", // ID único para cada cuenta
        images: [
            '/img/accounts/account2.png',
            '/img/accounts/account2-2.png',
            '/img/accounts/account2-3.png',
            '/img/accounts/account2-4.png',
            '/img/accounts/account2-5.png',
            '/img/accounts/account2-6.png',
            '/img/accounts/account2-7.png'
        ],
        rank: 'Unranked - Handlevel [2021]',
        level: 31,
        champions: 26,
        skins: 3,
        blueEssence: '2,245',
