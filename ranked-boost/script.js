...
function addChampion(championId, displayName) {
    ...
    removeButton.addEventListener('click', () => {
        ...
        updatePoolChampVisibility(); // Agregar esta línea
...
function updateChampionWarning() {
    ...
    if (count > 0 && count < 3) {
        warningElement.textContent = `Selecciona ${3 - count} campeón${3 - count !== 1 ? 'es' : ''} más para aplicar el bonus`;
        warningElement.style.color = '#FFA726';
