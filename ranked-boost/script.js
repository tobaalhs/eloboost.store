// Inicializar todas las constantes y variables globales
...
function updatePrice(fromRankName, toRankName) {
    ...
    try {
        const price = calculatePrice(fromRankName, toRankName, selectedLPRange, selectedLane);
...
document.querySelectorAll('input[name="lp-range"], input[name="lane-choice"]').forEach(input => {
