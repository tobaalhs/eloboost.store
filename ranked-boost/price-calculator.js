...
function calculatePrice(fromRank, toRank, lpRange, selectedLane, lpGain = '20-25') {
    ...
    if (championSet && championSet.size >= 3) { // Cambiar esta línea
        const championMultiplier = 1.3; // 30% de aumento
        const championBonus = totalPrice * (championMultiplier - 1);
        debugLog(`Bonus por campeones específicos (30%):`, championBonus);
